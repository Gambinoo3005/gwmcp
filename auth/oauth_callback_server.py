...
# Event signaled when OAuth authentication completes successfully.
# Used by CLI mode to wait for the user to finish the browser auth flow.
auth_completed_event = threading.Event()
    ...
    def _setup_callback_route(self):
        ...
        async def oauth_callback(request: Request):
            ...
            try:
                ...
                # Signal that auth is complete (used by CLI mode wait loop)
                auth_completed_event.set()
